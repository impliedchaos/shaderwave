...
export const iadditive: InstrumentDef = {
  ...
  presets: [
    ...
    // — bowed strings (focused sawtooth: balanced odd/even ~0.4 + moderate coherence so it
    //   reads as a bowed string, not a random-phase synth wash; rich detune + shimmer keep
    //   the focused tone alive; body/presence formant + a touch of natural inharmonicity) —
    { name: 'Violin',         p0: [1024, 0.5,  0.02, 0.0], p1: [0,  0.5, 0.3,  0.0], p2: [0.08, 0.35, 0.4, 0.55], p3: [0.2,  0.48, 0.8, 0.9], p4: [0.25, 0, 0, 0] },
    { name: 'Cello',          p0: [1536, 0.45, 0.02, 0.0], p1: [0,  0.5, 0.32, 0.0], p2: [0.12, 0.5,  0.4, 0.5],  p3: [0.18, 0.22, 1.0, 1.2], p4: [0.35, 0, 0, 0] },
    { name: 'Double Bass',    p0: [2048, 0.4,  0.02, 0.0], p1: [0,  0.5, 0.35, 0.0], p2: [0.18, 0.7,  0.4, 0.45], p3: [0.15, 0.1,  1.2, 1.5], p4: [0.4,  0, 0, 0] },
