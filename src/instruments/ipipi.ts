...
// frequency-dependent decay, a detuned string-pair beating, and a hammer thunk — the
// piano physics that matter, in the closed-form style (no recursion). Fits the
